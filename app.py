...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Xuyến - Trường TH Đông An - ĐT: 094 5064 556</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Xuyến - Trường TH Đông An - ĐT: 094 5064 556</div>", unsafe_allow_html=True)
